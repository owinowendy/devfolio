    ...
    <v-container fluid light-blue lighten-5>
      <v-layout row justify-center class="pb-8">
        ...
        <v-flex md3 xs11 sm11 mb-5 class="text-center">
          ...
          <h4>
            <a
              class="no-underline"
              target="_blank"
              href="mailto:wendyowino18@gmail.com"
              >wendyowino18@gmail.com</a
            > | <a
              class="no-underline"
              target="_blank"
              href="mailto:info@offiialwendybhanji@gmail.com"
          >offiialwendybhanji@gmail.com</a
          >
          </h4>
        </v-flex>
        <v-flex md2 xs11 sm11 class="text-center">
          ...
          <p>
            <a class="no-underline" href="tel:+254748730956">
              <strong>Call:</strong> +254 115104377
            </a>
          </p>
        </v-flex>
      </v-layout>
